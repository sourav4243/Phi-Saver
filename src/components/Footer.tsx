        ...
        <div className="max-w-[1440px] mx-auto px-2 sm:px-4">
          <div className="flex items-center justify-between py-1 sm:py-2">
            ...
            <button 
              ...
              className="flex flex-col items-center justify-center -mt-6 sm:-mt-8 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 sm:p-4 shadow-lg border-4 border-black transform scale-90 sm:scale-100"
            >
